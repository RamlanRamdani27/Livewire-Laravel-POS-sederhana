            ...
            <div class="card-body">
                <div class="row">
                    @forelse ($products as $product)
                        <div class="col-md-3 mb-3" :key="{{$product->id}}" style="cursor: pointer;">
                            <div class="card" wire:click="addItem({{$product->id}})">
                                <img src="{{ asset('storage/images/'.$product->image) }} " alt="product image" style="object-fit: contain; width:100%; height: 170px; ">
                        ...
                        @forelse ($carts as  $index=>$cart)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <a href="#" class="font-weight-bold text-dark">{{"Rp " . number_format($cart['pricesingle'],2,',','.')}}</a>
                                </td>
                                <td>
        ...
        <div class="card mt-4">
            <div class="card">
                ...
                <form wire:submit.prevent="handleSubmit">
                    ...
                    <div>
                        <label>Change</label>
                        <h1 id="changeText" wire:ignore>Rp. 0</h1>
                    </div>
  ...
  @push('script-custom')
    <script>
        payment.oninput = () => {
            ...
            document.getElementById("changeText").innerHTML = `Rp ${rupiah(changeAmount)} ,00`
